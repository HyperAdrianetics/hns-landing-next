...
const Techonolgies = () => {
  const techItems = [
    ...
    { src: nodeJs, alt: "Node.js", selected: false },
    { src: python, alt: "Python", selected: false },
    { src: typescript, alt: "TypeScript", selected: false },
    { src: aws, alt: "AWS", selected: false },
    { src: docker, alt: "Docker", selected: false },
    { src: postgresSql, alt: "PostgreSQL", selected: false },
    { src: mongoDb, alt: "MongoDB", selected: false },
    { src: nextJs, alt: "Next.js", selected: false },
    { src: reactNative, alt: "React Native", selected: false },
  ];
  return (
    <section id="technologies" className="min-h-screen p-5 container mx-auto">
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-6 gap-0 w-full border border-[#383E36]">
        <article className="col-span-2 md:col-span-2 lg:col-span-2 flex items-center justify-center ring-1 ring-inset ring-[#383E36] min-h-[230px]">
          <h2 className="text-4xl font-bold mb-4 text-[var(--primaryYellow)]">
            Tecnologías <br />
        ...
        {techItems.map((item) => (
          ...
          >
            ...
            <Image src={item.src} alt={item.alt} height={95} />
          </article>
        ))}
      </div>
    </section>
